...
val congruentInputData: InputData = InputData(
    groundTruthBoundingBox = GroundTruthBoundingBox(
        left = 3,
        top = 4,
        right = 10,
...
val nonOverlappingInputData: InputData = InputData(
    groundTruthBoundingBox = GroundTruthBoundingBox(
        left = 2,
        top = 2,
        right = 6,
...
val predictedInsideGroundTruthInputData: InputData = InputData(
    groundTruthBoundingBox = GroundTruthBoundingBox(
        left = 3,
        top = 3,
        right = 10,
...
val groundTruthInsidePredictedInputData: InputData = InputData(
    groundTruthBoundingBox = GroundTruthBoundingBox(
        left = 4,
        top = 4,
        right = 8,
...
val twoLinesAsInputData: InputData = InputData(
    groundTruthBoundingBox = GroundTruthBoundingBox(
        left = 8,
        top = 4,
        right = 8,
...
val groundTruthLinePredictedSquareInputData: InputData = InputData(
    groundTruthBoundingBox = GroundTruthBoundingBox(
        left = 8,
        top = 4,
        right = 8,
