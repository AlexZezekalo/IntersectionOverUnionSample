...
class ValidatorImplTest {
    ...
    @Test
    fun `validate incorrect BoundingBox coordinate range`(): Unit =
        runBlocking {
    ...
    @Test
    fun `validate correct BoundingBox coordinates`() =
        runBlocking {
    ...
    @Test
    fun `validate incorrect Right and Bottom range BoundingBox coordinate`() =
        runBlocking {
