...
class CustomGraphView : FrameLayout {
    ...
    private var groundTruthColorInt: Int? = null
    private var groundTruthPaint: Paint? = null

    private var predictedColorInt: Int? = null
    private var predictedPaint: Paint? = null
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        requireNotNull(groundTruthPaint) { "groundTruthPaint is null" }.also {
            drawBoundingBox(canvas, it, groundTruthBoundingBox)
        }
        requireNotNull(predictedPaint) { "predictedPaint is null" }.also {
            drawBoundingBox(canvas, it, predictedBoundingBox)
        }
