...
class ValidatorImpl
    ...
    constructor() : Validator {
        override suspend fun validateBoundingBoxCoordinates(boundingBox: BoundingBox): ValidationResult {
            val errors: HashMap<Coordinate, CustomException?> =
                HashMap(EnumSet.allOf(Coordinate::class.java).associateWith { null })
        ...
        private fun validateRightCoordinate(
        ...
        private fun validateBottomCoordinate(
            boundingBox: BoundingBox,
            errors: HashMap<Coordinate, CustomException?>,
        ) {
